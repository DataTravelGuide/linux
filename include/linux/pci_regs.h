...
#define  PCI_EXP_DEVCTL2_IDO_REQ_EN	0x0100	/* ID-based ordering request enable */
#define  PCI_EXP_DEVCTL2_IDO_CMP_EN	0x0200	/* ID-based ordering completion enable */
#define  PCI_EXP_DEVCTL2_LTR_EN		0x0400	/* Latency tolerance reporting */
