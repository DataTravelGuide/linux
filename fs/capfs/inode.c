...
struct inode *capfs_get_inode(struct super_block *sb, struct capfs_inode_param *param)
{
	...
	struct dentry *backing_meta_file_dentry;

	backing_dentry = param->backing_dentry;
	backing_data_file_dentry = param->backing_data_file_dentry;
	backing_meta_file_dentry = param->backing_meta_file_dentry;
	...
	if (backing_meta_file_dentry)
		ti->backing_meta_file_dentry = dget(backing_meta_file_dentry);
