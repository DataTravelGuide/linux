 ...
 *
 * In caln below:
 *	base may overflow, but since there isnÃ¢ÂÂt any additional division
 *	performed on base itÃ¢ÂÂs OK
 *	rem canÃ¢ÂÂt overflow because both are 32-bit values
 */
