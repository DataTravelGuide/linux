...
/**
 * submit_cache_miss_req - Submit a backend request when cache data is missing
 ...
 * backend using `pcache_queue_req_to_backend`. Finally, `pcache_req_put` is called to
...
/**
 * create_cache_miss_req - Create a backend read request for a cache miss
